...
let common_binary_op_overloading =
  all_builtin_vec_types @ all_builtin_matrix_types
  |> List.map (fun (s, _) -> binary_op_type_simple (TyNamed s))
