...
public:
  ViewerApp() : Application("Viewer", 800, 600) {}
  ~ViewerApp() {
...
private:
  ...
  void init() override {
    ...
    _vertices = std::vector<Vertex>({
        ...
        {0.5f, -0.5f, 1.0f, 0.0f, 0.0f},  // right-down
        {-0.5f, 0.5f, 0.0f, 1.0f, 0.0f},  // left-up
        {0.5f, 0.5f, 1.0f, 1.0f, 0.0f}    // right-up
    });
